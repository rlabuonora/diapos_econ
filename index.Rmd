...
- El ingreso total de las empresas es $P.Q$
- Si sube $P$, baja $Q$.
- Qué pasa con el ingreso de las empresas si sube el precio?
...
- Si la demanda es muy elástica, la caída en $Q$ va a ser grande, el ingreso total $P.Q$ cae.
- Si la demanda es inelástica, la caída en $Q$ va a ser baja, el ingreso total $P.Q$ sube.
